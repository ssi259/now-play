...
exports.create_payment = async(req,resp)=>{
    ...
    try{
        ...
        var processed_reponse =  await PaymentManager.process_create_input_req(input_response)
        var post_process_response = await PaymentManager.post_create_process(req,resp,processed_reponse)
    }catch(e){
        console.log(e)
...
exports.update_payment = async(req,resp)=>{
    ...
    try{
        ...
        var processed_reponse =  await PaymentManager.process_update_input_req(input_response)
        var post_process_response = await PaymentManager.post_create_process(req,resp,processed_reponse)
    }catch(e){
        console.log(e)
        const status_code = e.statusCode ? e.statusCode : 500
