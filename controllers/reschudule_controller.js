const reschedule_manager = require('../services/reschedule_manager')
...
exports.rescheduling = async(req,resp)=>{      
    try{
        ...
        var post_process_response = await RescheduleManager.post_reschedule_process(req,resp,processed_reponse)
    }catch(e){
        console.log(e)
