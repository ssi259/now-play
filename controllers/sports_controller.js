...
exports.create_sport = async(req,resp)=>{
    ...
    try{
        var input_response =  await SportManager.pre_process_create_sport(req)
        await SportManager.process_sport_input_req(input_response)
        await SportManager.post_sport_process(resp)
    }catch(e){
        console.log(e)
