...
exports.pre_process_reschedule = async(req,resp)=>{
  ...
  exports.process_reschedule_input_req = async(req,resp,input_response)=>{
    const rescheduled = await Reschedule.create({batch_id: req.body.batch_id,previous_end_time: req.body.previous_end_time,previous_start_time: req.body.previous_start_time,
